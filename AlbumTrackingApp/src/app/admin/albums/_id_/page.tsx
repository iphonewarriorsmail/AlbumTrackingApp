      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-[2.5rem] border border-slate-200 dark:border-zinc-800 shadow-xl overflow-hidden">
             ...
             {sections.length === 0 && <div className="p-10 text-center text-slate-400 text-sm font-bold">No hay secciones</div>}
          </div>
        </div>

        {/* Columna Derecha: Stickers de la Sección */}
            ...
            <>
              <div className="flex justify-between items-center px-4">
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 font-bold uppercase mt-1">Define los códigos oficiales de esta sección</p>
                </div>
                <button 
                 ...
                 <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4">
                    ...
                    {stickers.length === 0 && (
                      <div className="col-span-full py-20 text-center">
                         ...
                         <p className="text-slate-400 font-bold uppercase text-xs tracking-widest">Sección vacía</p>
                      </div>
                    )}
                 </div>
              </div>
